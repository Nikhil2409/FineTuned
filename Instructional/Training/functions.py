...
def train_model_simple(model, train_loader, val_loader, optimizer, device, num_epochs,
    ...
    train_losses, val_losses, track_tokens_seen = [], [], [] # KEEP ARRAYS for console output
    ...
    for epoch in range(num_epochs):
        ...
        for step, (input_batch, target_batch) in enumerate(train_loader):
            ...
            # --- FIX: Squeeze the input to ensure it is 2D ([B, S]) ---
            # This prevents the "too many values to unpack" error in the model's forward pass
    ...
    # Return the three original arrays
